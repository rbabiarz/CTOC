...
export const PERSONS: string[] = ['M. Okafor (T2)', 'S. Lin (T2)', 'R. Patel (T1)', 'D. Vance (T3)', 'L. Mendez (Fraud)', 'A. Wu (T1)', 'K. Brennan (IR)', 'J. Reyes (T1)'];
...
export const FEED_SOURCES: string[] = ['EDR/Carbon Black', 'NDR/Vectra', 'IDP/Okta', 'CASB/Netskope', 'SIEM/Splunk', 'Email/Proofpoint', 'DLP/Forcepoint', 'Fraud/Acme', 'Vuln/Tenable'];
