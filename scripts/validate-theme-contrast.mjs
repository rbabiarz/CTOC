...
const themes = {
  light: {
    ...
    '--sev-critical': '#d81b2a',
    '--sev-critical-solid': '#d81b2a',
    '--on-sev-critical': '#ffffff',
...
const checks = [
  ...
  { fg: '--on-sev-critical', bg: '--sev-critical-solid', label: 'Critical severity pill (solid)', level: AA_NORMAL },
  { fg: '--sev-critical', bg: '--panel-bg', label: 'Critical text/value on panel', level: AA_NORMAL },
  { fg: '--sev-critical', bg: '--color-canvas', label: 'Critical text on canvas', level: AA_NORMAL },
